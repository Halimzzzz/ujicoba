...
//  memeriksa apakah semua kriteria telah diisi untuk setiap alternatif dalam matriks
...
if ($cek > 0) {
	...
	//  menghitung jumlah total bobot kriteria
	...
	if ($total_bobot > 100 || $total_bobot < 100) {
		...
		// nilai-nilai subkriteria untuk setiap alternatif akan tersimpan dalam bentuk matriks dua dimensi dalam $array_nilai
		$array_nilai = array();
		$i = 0;
...
// MENENTUKAN NILAI MIN DAN MAX SETIAP KOLOM 
		$min = array();
		$max = array();
...
// data jenis kriteria akan tersimpan dalam array $jenis_kriteria, dan data bobot kriteria akan tersimpan dalam array $bobot_kriteria. Data ini akan digunakan dalam perhitungan selanjutnya untuk menentukan nilai utilitas dan nilai akhir dari setiap alternatif.
...
// nilai utilitas dari matriks nilai akan tersimpan dalam array $nilai_utility,
		$nilai_utility = array();

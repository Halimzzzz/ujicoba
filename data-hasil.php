...
<head>
    ...
    <link href="css/styles_dash1.css" rel="stylesheet" />
...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            ?>
                            <p class="fs-5" style="text-align: justify;">Berdasarkan hasil perhitungan Sistem Pendukung Keputusan dengan menggunakan metode SMART, berikut adalah hasil perangkingan seleksi haflah juz-amma PPTQ Al-Asy'ariyyah.</p>
                            <div class="table-responsive" action="proses.php" method="post">
                                <table class="table table-bordered" width="100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $username = $_SESSION['username'];
                                        $query = mysqli_query($koneksi, "SELECT alternatif.nama_alternatif AS nama, peringkat.nilai_peringkat AS nilai FROM alternatif JOIN peringkat ON alternatif.id_alternatif = peringkat.id_alternatif WHERE peringkat.username = '$username' ORDER BY peringkat.nilai_peringkat DESC");
                                        $no = 1;
                                ...
                                <div class="text-center mb-3">
                                    <a href="print.php?validasi=sukses" class="btn btn-primary">Detail Perhitungan</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <footer class="py-2 bg-success mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-light text  ">&copy; Copyright Sistem Pendukung Keputusan PPTQ AL-ASY'ARIYYAH </div>
                    </div>
                </div>
            </footer>
        </div>

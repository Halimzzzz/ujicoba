...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-success hstack gap-3">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="menu-utama.php">SPK AL-ASY'ARIYYAH</a>
        <!-- Sidebar Toggle-->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="proses.php" method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-floating mb-3">
                                                    <input name="nilai" class="form-control" id="inputEmail" type="text" placeholder="Nilai Subkriteria" pattern="[0-9]{1,2}|100" oninvalid="this.setCustomValidity('Input hanya angka minimal 0 dan maksimal 100')" oninput="setCustomValidity('')" required autocomplete="off" />
